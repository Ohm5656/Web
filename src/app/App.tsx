...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-screen pt-32 pb-20 lg:pt-0 flex items-center justify-center overflow-hidden bg-white">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <div className="flex items-center justify-center w-8 h-8 bg-slate-900 text-white rounded-md font-bold text-lg">
                <Layout className="w-5 h-5" />
              </div>
              <span className="font-bold text-slate-800 tracking-wider text-sm uppercase">PREMIUM DESIGN</span>
            </motion.div>
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white rounded-2xl p-6 shadow-md hover:shadow-2xl transition-all cursor-pointer border border-slate-100 hover:border-blue-200"
                >
      ...
      {/* Final CTA Section */}
      <section className="py-32 px-6 bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 relative overflow-hidden">
